<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="<?php echo e(asset('admin')); ?>/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">IMP Date</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="<?php echo e(url('admin/dashboard')); ?>" class="d-block"><?php echo e($user->name); ?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
              <a href="<?php echo e(route('tag.create')); ?>" class="nav-link active">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH D:\laraprac\impdateblog\resources\views/components/leftsidebar.blade.php ENDPATH**/ ?>