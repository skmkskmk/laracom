                 ...
                 <div class="card-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <td> <?php echo e($t->status ? 'Active' : 'Inactive'); ?></td>
                      <td>
                      <a href="<?php echo e(route('tag.edit',$t->id)); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                      <form method="post" action="<?php echo e(route('tag.destroy',$t->id)); ?>" onsubmit="return confirm('Are You Sure Want To Delete?')">
                              <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?> <?php /**PATH D:\laraprac\impdateblog\resources\views/admin/tag/index.blade.php ENDPATH**/ ?>